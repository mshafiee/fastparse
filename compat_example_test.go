...
func ExampleQuotedPrefix() {
	...
	// Output:
	// "", strconv.QuotedPrefix: parsing "not a quoted string": invalid syntax
...
func ExampleUnquote() {
	...
	// Output:
	// "", strconv.Unquote: parsing "You can't unquote a string without quotes": invalid syntax
	// "The string must be either double-quoted", <nil>
	// "or backquoted.", <nil>
	// "☺", <nil>
	// "", strconv.Unquote: parsing "'\u2639\u2639'": invalid syntax
}
