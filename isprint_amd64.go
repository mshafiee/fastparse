...
// isPrintASM is the assembly-optimized version of IsPrint
//
//go:noescape
func isPrintASM(r rune) bool

// isPrintOptimized uses assembly optimizations for fast IsPrint checking
func isPrintOptimized(r rune) bool {
	// Fast path for common ASCII range using branchless computation
	// 0x20 <= r <= 0x7E
	if r <= 0x7E {
